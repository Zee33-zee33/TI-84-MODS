...
// Simple 8x8 font atlas (ASCII characters 32-127)
...
static const uint8_t font_data[96][8] = {
    ...
    // Remaining characters filled with empty glyphs for simplicity
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // [
...
void font_draw_char(int x, int y, char c, color_t fg, color_t bg) {
    ...
    int index = uc - 32;
    draw_tile(x, y, font_data[index], fg, bg);
}
